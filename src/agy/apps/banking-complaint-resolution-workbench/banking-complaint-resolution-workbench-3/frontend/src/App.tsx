...
function App() {
      ...
      if (complaints.length === 0) {
        const offlineFallbacks: Complaint[] = [
          ...
          },
          {
            ...
            severity: "Medium",
            status: "New",
            description: "Savings account interest rate was not applied correctly for the last quarter.",
          ...
          },
          {
            ...
            severity: "Low",
            status: "New",
            description: "Double billing of $150 on credit card monthly statement.",
          ...
          },
          {
            ...
            severity: "High",
            status: "New",
            description: "Overdraft fees charged despite having sufficient funds in associated savings account.",
  ...
  // Redirect to dashboard if an unauthorized role somehow accesses the register complaint view
  useEffect(() => {
    if (activeRole !== 'Intake Specialist' && currentView === 'new-complaint') {
      setCurrentView('dashboard');
    }
