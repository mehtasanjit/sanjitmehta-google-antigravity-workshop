...
# Set test database environment variable before importing database models/engines
...
def client_fixture():
    # Setup clean distinct database for API testing by dropping and recreating tables
