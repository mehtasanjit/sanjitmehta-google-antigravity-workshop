...
9.  **Attach Task Summary with Git Notes:**
    ...
    -   **Step 9.3: Attach Note:** Use the `git notes` command to attach the summary to the commit (`git notes add -m "<note content>" <commit_hash>`).
...
-   [ ] Works correctly on mobile / responsive screen sizes
